<!--Modal eliminar-->
<div id="modal-eliminar_<?php echo $data['id_pendientes']; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-delete-label" aria-hidden="true" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 id="modal-login-label" class="modal-title">DESEA ELIMINAR ESTA TAREA</h3>
                    </div>
                    <form class="forms-sample" action= "classes/delete_moroso.php" method = "POST">
