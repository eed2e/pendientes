            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <form class="forms-sample" action= "classes/update_moroso.php" method = "POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="descripcion_editar" name="descripcion_editar" rows="4"><?php echo $data['descripcion']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="descripcion_editar">RAZON</label>
                                        <textarea class="form-control" id="razon_editar" name="razon_editar" rows="3"><?php echo $data['razon']; ?></textarea>
                                    </div>
